...
# Initialiser le modèle de Régression Elastic Net
alpha = 1.0  # Force de régularisation, ajustez selon vos besoins
l1_ratio = 0.5  # Ratio de régularisation L1 (entre 0 et 1)
...
model_filename = f'elastic_net_regression_model_alpha_{alpha}_l1_ratio_{l1_ratio}.joblib'
